...
class GCPAdapter(CloudAdapter):
    def __init__(
        ...
        bucket_process: str,
        bucket_database: str,
        landing_events_prefix: str,
        landing_country_risk_prefix: str,
        bronze_events_prefix: str,
        bronze_country_risk_prefix: str,
        silver_events_prefix: str,
        bq_staging_prefix: str
    ):
    ...
    def bq_staging_path(self) -> str:
        # Nota: BigQuery connector pide bucket sin gs:// para temporaryGcsBucket,
        # pero aquí documentamos el prefijo de staging por claridad.
        return f"gs://{self.bucket_database}/{self.bq_staging_prefix}/"
